    ...
    <div class="lab-rail__scroll">
      <template v-if="recommendations.length">
        <section class="lab-detail__section">
          <h2 class="lab-detail__heading">推荐实验</h2>
      ...
      <template v-else-if="detail">
        ...
        <section v-if="detail.expName" class="lab-detail__section">
          <h2 class="lab-detail__heading">{{ detail.expName }}</h2>
        ...
        <section v-if="materials.length" class="lab-detail__section">
        ...
        <section v-if="steps.length" class="lab-detail__section">
        ...
        <section v-if="results.length" class="lab-detail__section">
        ...
        <section v-if="hasCaution || hasDanger" class="lab-detail__section">
        ...
        <section v-if="references.length" class="lab-detail__section">
        ...
        <section v-if="scientists.length" class="lab-detail__section lab-detail__section--last">
